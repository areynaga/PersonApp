 ...
 * generated in the be.steria.datapoc.model package. 
...
public class ObjectFactory {
    ...
    private final static QName _CUDReplica_QNAME = new QName("http://datapoc.steria.be/model", "CUDReplica");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: be.steria.datapoc.model
     * 
     */
    public ObjectFactory() {
    }

    public CUDReplica createCUDReplica() {
    	return new CUDReplica();
    }
    
    @XmlElementDecl(namespace = "http://datapoc.steria.be/model", name = "CUDReplica")
    public JAXBElement<CUDReplica> createCUDReplica(CUDReplica value) {
        return new JAXBElement<CUDReplica>(_CUDReplica_QNAME, CUDReplica.class, null, value);
    }
