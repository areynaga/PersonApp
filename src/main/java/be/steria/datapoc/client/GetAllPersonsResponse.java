 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://datapoc.steria.be/model}person" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "getAllPersonsResponse", namespace = "http://services.datapoc.steria.be/", propOrder = {
    "_return"
})
